...
# Make Sphinx warn about bad cross references
nitpicky = True
...
htmlhelp_basename = 'BrownWaterPythondoc'
...
latex_documents = [
    (master_doc, 'BrownWaterPython.tex', 'Brown Water Python Documentation',
     'Aaron Meurer', 'manual'),
]
...
man_pages = [
    (master_doc, 'brownwaterpython', 'Brown Water Python Documentation',
     [author], 1)
]
